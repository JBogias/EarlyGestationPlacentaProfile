...
```{r draw_venn}
# Lets draw a triple venn now
# cat.cex changed from 5 to 3.5
png(filename = here("data/figures/Figure_2.png"),
    width = 27.5,
    height = 21.725,
    units = "cm",
    res = 300)
...
gene_tx_diff %>%
  write_csv(here("data/results/figure3_transcripts.csv"))
```
...
Save figure 3
```{r}
png(filename = here("data/figures/Figure_3.png"),
    width = 27.5,
    height = 21.725,
    units = "cm",
    res = 300)
