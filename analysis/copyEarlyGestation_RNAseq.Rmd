...
gene_anno <- read_csv("~/Documents/PhD/R_Projects/Differential_Transcript_Usage/Data/Annotations/grch38_gene_anno.csv.gz")

txp_anno <- read_csv("~/Documents/PhD/R_Projects/Differential_Transcript_Usage/Data/Annotations/grch38_txp_anno.csv.gz")
```
...
DGElist %>%
  write_rds(here("data/counts/dgelist.rds"))
```
...
DTElist %>%
  write_rds(here("data/counts/dtelist.rds"))
```
...
```{r write_csv_tx}
oxygenTranscripts %>%
  write_csv(here("data/results/oxygenTranscripts.csv.gz"))

sig_tx %>%
  write_csv(here("data/results/sig_tx.csv.gz"))
```
